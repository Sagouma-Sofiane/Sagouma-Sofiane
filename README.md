...
<body>
  ...
  <script>
    ...
    var data1 = {
      labels: ['Innovative Thinking', ''],
      datasets: [{
        data: [80, 20], // Change percentages as needed
        backgroundColor: ['#FF5089', '#f2f2f2'],
      }]
    };

    var data2 = {
      labels: ['Strong Communication', ''],
      datasets: [{
        data: [70, 30], // Change percentages as needed
    ...
    var data3 = {
      ...
      datasets: [{
        data: [90, 10], // Change percentages as needed
        backgroundColor: ['#E8232E', '#f2f2f2'],
      }]
    };
    ...
    var data4 = {
      ...
      datasets: [{
        data: [85, 15], // Change percentages as needed
        backgroundColor: ['#4BC0C0', '#f2f2f2'],
      }]
    };
